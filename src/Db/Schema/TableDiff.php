...
class TableDiff extends AbstractTable
{
    /**
    ...
    public static function create($name, $definition)
    {
        ...
        if (isset($definition['renamedColumns'])) {
            ...
            foreach ($definition['renamedColumns'] as $name => $col) {
                ...
                $data[$name] = Column::create($col_name, $col_def);
            }
            $def['renamedColumns'] = $data;
        }
        foreach (['dropedColumns' => Column::class,
                  'newColumns' => Column::class,
                  'modifiedColumns' => Column::class,
                  'dropedIndexes' => Index::class,
                  'newIndexes' => Index::class,
                  'dropedReferences' => Reference::class,
                  'newReferences' => Reference::class] as $field => $clz) {
